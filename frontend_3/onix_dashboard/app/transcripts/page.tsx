      ...
      <AppShell title={`${botMeeting?.title || `Bot Meeting`}`} subtitle={`Created ${(() => {
        ...
        <Tabs value={activeTab} onValueChange={(value) => setActiveTab(value as any)} className="w-full space-y-4">
          <TabsList className="w-full flex flex-wrap h-auto bg-slate-100/80 dark:bg-slate-800/80 p-1 gap-2 border-b border-white/20 dark:border-slate-700/50">
            ...
            <TabsTrigger value="actions" className="flex-1 min-w-[100px] gap-2 data-[state=active]:bg-white dark:data-[state=active]:bg-slate-900 dark:data-[state=active]:text-white data-[state=active]:shadow-sm">
              <CheckSquare className="size-4" />
              Action Items
            </TabsTrigger>
            <TabsTrigger value="stats" className="flex-1 min-w-[140px] gap-2 data-[state=active]:bg-white dark:data-[state=active]:bg-slate-900 dark:data-[state=active]:text-white data-[state=active]:shadow-sm">
